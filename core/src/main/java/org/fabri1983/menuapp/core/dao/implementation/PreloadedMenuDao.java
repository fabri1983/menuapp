...
public class PreloadedMenuDao implements MenuDao {
	...
	public PreloadedMenuDao()
	{
		...
		JsonMenuPresentation dinnerSuperb = new JsonMenuPresentation(
				1L, "Superb Dinner", "It's an interesting dinner menu.", 
				"http://fabri1983.org/images/dinnerSuperb.png", 
		...
		JsonMenuPresentation dinnerCheap = new JsonMenuPresentation(
				2L, "Cheapest Dinner", "Are you saving some dimes?", 
				"http://fabri1983.org/images/dinnerCheap.png", 
		...
		JsonMenuPresentation lunchAmazing = new JsonMenuPresentation(
				3L, "Amazing Lunch", "No one deserve this lunch more than you.", 
				"http://fabri1983.org/images/lunchAmazing.png", 
		...
		JsonMenuPresentation lunchNotTasty = new JsonMenuPresentation(
				4L, "Not so tasty lunch", "It's not a taaaaasty lunch. You're warned.", 
				"http://fabri1983.org/images/lunchNotTasty.png", 
